...
$pageTitle = 'PDF Metadata Düzenle';
$pageDesc  = 'PDF başlık, yazar, konu ve anahtar kelimeleri düzenle. Dosyalar sunucuya yüklenmez.';

Tool::ensure('pdf_metadata', 'PDF Metadata');
$tool = Tool::get('pdf_metadata') ?? ['status'=>'active','meta'=>[]];
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  try {
    ...
    Tool::recordUse('pdf_metadata', 1, $files);
...
if ($toolStatus !== 'active') {
  ...
  render('tools_pdf_metadata', compact('pageTitle','pageDesc','error'));
  return;
}

render('tools_pdf_metadata', compact('pageTitle','pageDesc','toolStatus'));
